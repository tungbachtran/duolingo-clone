// src/features/authentication/pages/VerifyEmailPage.tsx
...
export const VerifyEmailPage = () => {
  ...
  const [timeLeft, setTimeLeft] = useState(60); // 60 giây để nhập mã
  ...
  useEffect(() => {
    ...
    // Countdown để về trang register sau 60 giây
  ...
  const handleResend = async () => {
    ...
    if (res.success) {
      ...
      setCountdown(60);
      setCanResend(false);
      setTimeLeft(60); // Reset thời gian nhập mã
    } else {
      showToast(res.message, ToastType.ERROR);
    }
  };
